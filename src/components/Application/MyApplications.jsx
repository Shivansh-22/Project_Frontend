...
const MyApplications = () => {
  ...
  useEffect(() => {
    try {
      if (user && user.role === "Faculty") {
        axios
          .get(
            "https://project-backend-0orf.onrender.com/api/v1/application/faculty/getall",
            {
        ...
        axios
          .get(
            "https://project-backend-0orf.onrender.com/api/v1/application/student/getall",
            {
              withCredentials: true,
            }
          )
  ...
  const deleteApplication = (id) => {
    try {
      axios
        .delete(
          `https://project-backend-0orf.onrender.com/api/v1/application/delete/${id}`,
          {
            withCredentials: true,
          }
        )
...
const handleApproveApplication = async (applicationId) => {
  try {
    ...
    const { data: applicationData } = await axios.get(
      `https://project-backend-0orf.onrender.com/api/v1/application/${applicationId}`,
      { withCredentials: true }
    );

    // Fetch project data
    const { data: projectData } = await axios.get(
      `https://project-backend-0orf.onrender.com/api/v1/project/${applicationData.application.projectId}`,
      { withCredentials: true }
    );
    ...
    // Delete application
    await axios.delete(
      `https://project-backend-0orf.onrender.com/api/v1/application/delete/${applicationId}`,
      { withCredentials: true }
    );
    ...
    try {
      await axios.delete(
        `https://project-backend-0orf.onrender.com/api/v1/project/delete/${applicationData.application.projectId}`,
        { withCredentials: true }
      );
