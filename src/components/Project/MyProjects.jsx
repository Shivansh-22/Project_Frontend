...
const MyProjects = () => {
    ...
    const fetchProjects = async () => {
      try {
        const { data } = await axios.get(
          "https://project-backend-0orf.onrender.com/api/v1/project/getmyprojects",
  ...
  const handleUpdateProject = async (projectId) => {
    ...
    await axios
      .put(
        `https://project-backend-0orf.onrender.com/api/v1/project/update/${projectId}`,
        updatedProject,
        {
          withCredentials: true,
        }
  ...
  const handleDeleteProject = async (projectId) => {
    await axios
      .delete(`https://project-backend-0orf.onrender.com/api/v1/project/delete/${projectId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
